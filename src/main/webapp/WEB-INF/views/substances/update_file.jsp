...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'>
    ${kindVO.title } > ${substancesVO.title } 수정 > 파일 수정
  </DIV>
      ...
      <li class="li_none">
        <DIV style='text-align: center; width: 50%; float: left;'>
          <c:choose>
            ...
            <c:otherwise> <!-- 이미지가 없음 -->
               <IMG src="/substances/images/none1.png" style="width: 90%;"> 
            </c:otherwise>
          </c:choose>
        ...
        <DIV style='text-align: left; width: 47%; float: left;'>
          ...
          <FORM name='frm' method='POST' action='./update_file.do' enctype="multipart/form-data">
            ...
            <input type="hidden" name="now_page" value="${param.now_page == null ? 1 : param.now_page }">
            ...
            <div style='margin-top: 20px; clear: both;'>  
              ...
              <button type="submit" class="btn btn-info btn-sm">파일 삭제</button>
