...
<script type="text/javascript">
  ...
  function checkID() {
    ...
    if (id.value.trim().length == 0) {
      ...
      // 처리중 출력
      id_msg.innerHTML="<img src='/visitor/images/ani04.gif' style='width: 5%;'>"; // static 기준
...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' id='frm' method='POST' action='./create.do' class="">
    ...
    <div class="form-group">
      <label>나이*:
        <input type='number' class="form-control form-control-sm" name='age' id='age' value='20' required="required" placeholder="나이">
      </label>
    ...
    <div class="form-group">
      <label>성별*:
        <input type='text' class="form-control form-control-sm" name='sex' id='sex' value='남자' required="required" placeholder="성별">
      </label>
