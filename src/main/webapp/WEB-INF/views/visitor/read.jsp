...
window.onload = function() {
  ...
  function checkID() {
    ...
    if (id.value.trim().length == 0) {
      ...
      // 처리중 출력
      id_msg.innerHTML="<img src='/visitor/images/ani04.gif' style='width: 6%;'>"; // static 기준
...
<c:import url="/menu/top.do" />
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' class="">
    <input type="hidden" name="visitorno" value="${visitorVO.visitorno }">
    
    <div class="form-group"> <%-- 줄이 변경되지 않는 패턴 --%>
      <label>아이디*:
        <input type='text' class="form-control form-control-sm" name='id' id='id' value='${visitorVO.id }' required="required" placeholder="아이디*" autofocus="autofocus">
      </label>
    ...
    <div class="form-group"> <%-- label의 크기에따라 input 태그의 크기가 지정되는 형태 --%>
      <label>성명*:
        <input type='text' class="form-control form-control-sm" name='mname' id='mname' value='${visitorVO.mname }' required="required" placeholder="성명">
      </label>
      <span id='mname_msg'></span>
    </div>   
    <div class="form-group">
      <label>나이*:
        <input type='number' class="form-control form-control-sm" name='age' id='age' value='${visitorVO.age }' required="required" placeholder="나이">
      </label>
    ...
    <div class="form-group">
      <label>성별*:
        <input type='text' class="form-control form-control-sm" name='sex' id='sex' value='${visitorVO.sex }' required="required" placeholder="성별">
      </label>
    ...
    <div class="form-group"> <%-- label의 크기에따라 input 태그의 크기가 지정되는 형태, 줄이 변경되지 않는 패턴 --%>
      <label>전화 번호:
        <input type='text' class="form-control form-control-sm" name='tel' id='tel' value='${visitorVO.tel }' required="required" placeholder="전화번호">
      </label>
      예) 010-0000-0000
    </div>   
    ...
    <div class="form-group">
      <label>우편 번호:
        <input type='text' class="form-control form-control-sm" name='zipcode' id='zipcode' value='${visitorVO.zipcode }' placeholder="우편번호">
      </label>
    ...
    <div class="form-group">
      ...
      <input type='text' class="form-control form-control-sm" name='address1' id='address1' value='${visitorVO.address1 }' placeholder="주소">
    </div>   

    <div class="form-group">
      <label style="width: 100%;">상세 주소:</label>
      <input type='text' class="form-control form-control-sm" name='address2' id='address2' value='${visitorVO.address2 }' placeholder="상세 주소">
    </div>   
