...
<table class="table table-hover">
  <colgroup>
    ...
    <tbody>
      <c:forEach var="chattingVO" items="${list_by_reciver }" varStatus="info">
      <c:set var="chattingno" value="${chattingVO.chattingno }" />
      <tr onclick="location.href='./chatting_list_by_reciver.do?visitorno=${chattingVO.visitorno }&reciverno=${chattingVO.reciverno}'" style="cursor:pointer;">
