...
COMMENT ON COLUMN substances.visitorno is '방문자 번호';
...
VALUES(substances_seq.nextval, 1, 1, '교촌치킨', '한입에 쏘옥', 0, 0, 0, '123',
       '배달', '경기도 안양시', sysdate, 'space.jpg', 'space_1.jpg', 'space_t.jpg', 1000);

INSERT INTO substances(substancesno, visitorno, kindno, title, substance, recom, cnt, replycnt, passwd, 
                     word, address, rdate, file1, file1saved, thumb1, size1)
VALUES(substances_seq.nextval, 1, 1, '홍콩반점', '짜장면이 일품', 0, 0, 0, '123',
       '음식', '경기도 안산시', sysdate, 'space.jpg', 'space_1.jpg', 'space_t.jpg', 1000);
...
-- ----------------------------------------------------------------------------------------------------
-- step 1
SELECT substancesno, visitorno, kindno, title, substance, recom, cnt, replycnt, address, rdate,
...
-- 특정 그룹에 속한 게시글 삭제
DELETE FROM kind WHERE kindno=2;
